...
$auth_users = array(
    'admin' => '976fe27bb0808e60e035ed6920b61b85', //admin
);
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
                <img src="https://t.gyazo.com/teams/damineme/1f00da05457b5e0c985a29b559437556.png" alt="DAMINE File manager" style="margin:20px;">
...
<a href="https://www.damine.wtf" target="_blank" class="float-right" style="color:silver">by DAMINE</a></p>
<?php endif; ?>
</form>
...
<head>
<meta charset="utf-8">
<title>DAMINE | File Manager</title>
<meta name="Description" CONTENT="Author: CCP Programmers, DAMINE PHP File Manager">
...
<meta charset="utf-8">
<title>DAMINE | File Manager</title>
<meta name="Description" CONTENT="Author: CCP Programmers, DAMINE's PHP File Manager">
<link rel="icon" href="<?php echo FM_SELF_URL ?>?img=favicon" type="image/png">
<link rel="shortcut icon" href="<?php echo FM_SELF_URL ?>?img=favicon" type="image/png">
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css">
